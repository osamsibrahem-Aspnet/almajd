        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CreditNotes_AspNetUsers_IssuedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_InvoiceLines_Skus_SkuId",
                        column: x => x.SkuId,
                        principalTable: "Skus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CreditNotes_IssuedByUserId",
                table: "CreditNotes",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLines_InvoiceId_SkuId",
                table: "InvoiceLines",
                columns: new[] { "InvoiceId", "SkuId" });

            migrationBuilder.CreateIndex(
                name: "IX_InvoiceLines_SkuId",
                table: "InvoiceLines",
                column: "SkuId");

            migrationBuilder.CreateIndex(
                name: "IX_Invoices_CustomerId_Status_DueAt",
                table: "Invoices",
                columns: new[] { "CustomerId", "Status", "DueAt" });
